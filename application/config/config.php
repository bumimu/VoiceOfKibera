...
/**
 * Base path of the web site. If this includes a domain, eg: vps-ushahidi-mysql.crowdmap.com/ushahidi/
 * then a full URL will be used, eg: http://vps-ushahidi-mysql.crowdmap.com/ushahidi/. If it only includes
